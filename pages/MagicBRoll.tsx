    ...
    return (
        <div className="w-full">
            <FeatureHeader
                ...
                tutorialLink="https://youtu.be/hPYd6ghBs-U"
            />
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <main className="flex-grow w-full bg-white/50 dark:bg-gray-900/30 backdrop-blur-xl p-6 md:p-8 rounded-[2.5rem] border border-white/40 dark:border-white/5 shadow-inner min-h-[600px]">
