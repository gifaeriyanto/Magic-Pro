    ...
    return (
        <div className="w-full mx-auto">
            <FeatureHeader 
                ...
                tutorialLink="https://www.youtube.com/watch?v=2SwA-I3tl6M&feature=youtu.be"
            />
                                                ...
                                                {result.state === 'done' && (
                                                    <div className="relative w-full h-full group">
                                                        ...
                                                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 backdrop-blur-[1px]">
                                                            <a href={result.imageUrl} download={`magic_model_hd_${index}.png`} className="p-3 bg-white/20 backdrop-blur-md text-white rounded-full hover:bg-white/40 transition-colors shadow-lg" title="Unduh Gambar">
